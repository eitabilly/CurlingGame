...
//  CurlingGame
//
//  Created by 石田栄太 on 2016/08/16.
//
//

#ifndef StageSprite_hpp
#define StageSprite_hpp

#include <stdio.h>
#include "cocos2d.h"

class StageSprite : public cocos2d::Sprite
{
public:
     ...
     */
    StageSprite(const std::string& filename);
